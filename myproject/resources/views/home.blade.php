...
<div class="flex min-h-screen flex-col bg-white">
            ...
            <div class="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
                <div class="space-y-4">
                    <h1 class="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
                        Selamat Datang ke Portal Alumni 4B Malaysia
                    </h1>
                    <p class="md:text-xl text-white/90">
                        Menghubungkan semua bekas ahli 4B di seluruh Malaysia untuk terus menyumbang kepada pembangunan masyarakat dan negara.
                    </p>
    ...
    <section class="w-full py-12 md:py-24 lg:py-32 bg-white">
        <div class="container mx-auto px-4 md:px-6">
            <div class="flex flex-col items-center justify-center space-y-4 text-center mb-12">
                <div class="space-y-2">
                    <h2 class="text-3xl font-bold tracking-tight sm:text-5xl text-gray-900">Perkhidmatan Kami</h2>
                    <p class="max-w-[900px] text-gray-600 md:text-xl/relaxed">
                        Portal Alumni 4B menyediakan pelbagai perkhidmatan untuk memudahkan bekas ahli 4B untuk terus berhubung dan menyumbang.
                    </p>
                </div>
            </div>
            <div class="mx-auto grid max-w-5xl items-stretch gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="rounded-lg border bg-white shadow-sm overflow-hidden flex flex-col">
                    <div class="p-6 flex flex-row items-center gap-4 border-b">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Daftar dan semak status keahlian anda</p>
                        </div>
                    </div>
                    <div class="p-6 flex-1">
                        <p class="text-sm text-gray-600">
                            Sistem pengurusan keahlian yang komprehensif untuk memudahkan pendaftaran dan pengesahan keahlian alumni.
                        </p>
                    </div>
                    <div class="p-6 pt-0">
                ...
                <div class="rounded-lg border bg-white shadow-sm overflow-hidden flex flex-col">
                    <div class="p-6 flex flex-row items-center gap-4 border-b">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold">Aktiviti</h3>
                            <p class="text-sm text-gray-500">Program dan aktiviti terkini</p>
                        </div>
                    </div>
                    <div class="p-6 flex-1">
                        <p class="text-sm text-gray-600">
                            Maklumat mengenai program dan aktiviti yang dianjurkan oleh Alumni 4B di peringkat kebangsaan dan negeri.
                        </p>
                    </div>
                    <div class="p-6 pt-0">
                ...
                <div class="rounded-lg border bg-white shadow-sm overflow-hidden flex flex-col md:col-span-2 lg:col-span-1">
                    <div class="p-6 flex flex-row items-center gap-4 border-b">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Koleksi gambar aktiviti</p>
                        </div>
                    </div>
                    <div class="p-6 flex-1">
                        <p class="text-sm text-gray-600">
                            Galeri gambar aktiviti dan program yang telah dijalankan oleh Alumni 4B di seluruh Malaysia.
                        </p>
                    </div>
                    <div class="p-6 pt-0">
    ...
    <section class="w-full py-12 md:py-24 lg:py-32 bg-gray-100">
        <div class="container mx-auto px-4 md:px-6">
            <div class="flex flex-col items-center justify-center space-y-4 text-center mb-12">
                <div class="space-y-2">
                    <h2 class="text-3xl font-bold tracking-tight sm:text-5xl text-gray-900">Aktiviti Terkini</h2>
                    <p class="max-w-[900px] text-gray-600 md:text-xl/relaxed">
                        Sertai aktiviti-aktiviti terkini yang dianjurkan oleh Alumni 4B di seluruh Malaysia.
                    </p>
                </div>
            </div>
            <div class="mx-auto grid max-w-5xl gap-8 md:grid-cols-2">
                ...
                <div class="rounded-lg border bg-white shadow-sm overflow-hidden">
                    <div class="aspect-video bg-gray-200 flex items-center justify-center text-gray-400 font-medium">
                        Aktiviti {{ $i }}
                    </div>
                    <div class="p-6">
                        <h3 class="text-lg font-semibold">Program Khidmat Masyarakat {{ $i }}</h3>
                        <p class="mt-2 text-sm text-gray-500">10 Jun 2025 • Kuala Lumpur</p>
                        <p class="mt-4 text-sm text-gray-600">
                            Program khidmat masyarakat yang dianjurkan oleh Alumni 4B Kuala Lumpur dengan kerjasama pihak berkuasa tempatan.
                        </p>
                    </div>
                    <div class="p-6 pt-0">
                        <a href="{{ route('aktiviti.show', $i) }}" class="inline-flex items-center justify-center rounded-md text-sm font-medium bg-primary text-white hover:bg-primary/90 h-9 px-4">
                            Maklumat Lanjut
                        </a>
                    </div>
                </div>
            ...
            <div class="flex justify-center mt-12">
                <a href="{{ route('aktiviti.index') }}" class="inline-flex items-center justify-center rounded-md text-sm font-medium border border-gray-300 bg-white hover:bg-gray-50 h-10 px-6">
