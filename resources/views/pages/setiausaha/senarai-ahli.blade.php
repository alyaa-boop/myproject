...
<div class="max-w-7xl mx-auto px-4 mt-6 mb-10" x-data="membersListPage()">
    ...
    <div class="mt-6 border border-[#BAC4F7] rounded-lg bg-white overflow-hidden">
        ...
        <div class="p-6">
            {{-- Filters --}}
            <form method="GET" action="{{ route('senarai-ahli') }}" class="flex flex-col md:flex-row gap-4 mb-6 no-print">
                <div class="flex-1">
                ...
                <div class="flex gap-2">
                    ...
                    @if(request('q'))
                        <a href="{{ route('senarai-ahli') }}" class="rounded-md border border-[#BAC4F7] px-4 py-2 text-sm hover:bg-gray-50">Reset</a>
                    @endif
                </div>
            </form>
