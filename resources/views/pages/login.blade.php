    ...
    <div class="max-w-md mx-auto">
        ...
        <div class="rounded-lg border bg-white shadow-sm overflow-hidden" x-data="loginForm">
            ...
            <div class="p-6 border-t bg-gray-50 space-y-3">
                <p class="text-center text-sm text-gray-600">Belum menjadi ahli? <a href="{{ route('register') }}" class="text-primary hover:underline">Daftar sekarang</a></p>
                <a href="{{ route('registeracc') }}" class="w-full inline-flex items-center justify-center rounded-md text-sm font-medium border border-primary text-primary hover:bg-primary hover:text-white h-10">
                    Daftar Setiausaha / HQ Baru
                </a>
            </div>
        </div>
    </div>
